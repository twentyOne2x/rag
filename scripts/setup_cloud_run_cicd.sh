...
SECRET_IDS=(
  ...
  "EMBEDDING_MODEL_NAME_OSS"
  "EMBEDDING_MODEL_NAME_OPENAI"
  "EMBEDDING_MODEL_NAME"
  "ENVIRONMENT"
  "NUM_CHUNKS_RETRIEVED"
  "MIN_CHUNKS_FOR_RESPONSE"
  "NUM_CHUNKS_SEARCHED_FOR_RERANKING"
  "LLM_MODEL_NAME"
  "LLM_MODEL_NAME_OSS"
  ...
  "PINECONE_NAMESPACE"
  "YT_NAMESPACE_CONFIG"
  "PINECONE_NAMESPACE_VIDEOS"
  "PINECONE_NAMESPACE_STREAMS"
  "PIPELINE_STORAGE_DIR"
  "VOICE_LIBRARY_DIR"
  "SPEAKER_EMBED_CACHE_DIR"
  "VOICE_MATCH_THRESHOLD"
  "SPEAKER_MAP_DIR"
  "VOICE_EMBED_BACKEND"
  "VOICE_AUTO_ENROLL"
  "VOICE_ENROLL_MIN_TALK_S"
  "VOICE_AUTO_ENROLL_NAME"
)
