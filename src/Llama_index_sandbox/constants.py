...
INPUT_QUERIES = [
    ...
    # videos: Solana Seeker - The Web3 Mobile Evolution; A Better Internet, Built on Solana; Spotlight: Solana's Consensus
    "What is SOL used for on the Solana network?",
    # videos: The State of the USDC Economy Is Strong; Solana Seeker Keynote (Emmett Hollyer); Solana Stories: Fast, Cheap, and Reliable
    "What is a memecoin and why are they popular on Solana?",
    # videos: Make 100x Money With Memecoins TODAY!; Did Memecoins SAVE Crypto??; The TRUTH About Crypto Trading In 2024... w/ Ubermendes
    "What is Pump.fun and how does it work at a high level?",
    # videos: How Pumpfun ACTUALLY works | Founder Explains for BEGINNERS; How Memecoins Will Get You RICH | Pump Fun Founder's Full Insight; The Bull Thesis for Pumpfun
    "What does “trench” mean in crypto launches and why do people talk about it?",
    # videos: Letterbomb: The Dark Side of Trenching; Gwart & Robert Chang: Trenching...; The TRUTH About Crypto Trading In 2024... w/ Ubermendes
    "How do I set up a Solana wallet and avoid common scams?",
    # videos: How to Make Your Transactions Faster on #Solana; Building web3 Login Your Grandma Can Use; Developer Tutorial: How to Verify Your Solana Programs
    "What’s the difference between a DEX and a CEX on Solana?",
    # videos: The OG of Solana DeFi | Orca; Coinbase & DeFi; DRIFT: Building a Composite CEX-DEX Experience
    "What are Raydium and Orca, and what can I do with them?",
    # videos: The OG of Solana DeFi | Orca; Does DEX Liquidity Need a Defense Layer?; Adapting DEX Aggregation to Solana
    "What is slippage and why does it matter when trading on Solana?",
    # videos: How to SELL Your MEMECOINS for MAX PROFIT!! w/ Ansem; On-Chain Liquidity: The Past, Present and Future
    "What is an airdrop, and how do people qualify on Solana?",
    # videos: The Infinite-LST Future w/ FP Lee; Solana Incubator Cohort 2 Demo Day; Jupiter (Breakpoint 2024)
    "What are Solana Actions and Blinks, and why do people use them?",
    # videos: Solana Actions and Blinks; What Are You Building? with Dialect; In the Blink of an Eye (Chris Osborn)
    "What is Jito and how can it improve my transaction experience?",
    # videos: Solana Validator Education - Jito Relayer Setup; The State of Solana MEV; Jito StakeNet: A Protocol for Timeless LSTs
    "What is an AMM, explained like I’m new to DeFi?",
    # videos: The Phoenix Rises: Why Active Liquidity Enables Sustainable Markets; Widening the Design Space of AMMs with Solana; What Are You Building? with Orca
    "What is a bonding curve on Pump.fun?",
    # videos: How Pumpfun ACTUALLY works | Founder Explains; The Bull Thesis for Pumpfun; Legion: The Return of ICOs
    "What is a DAT (Digital Asset Token)?",
    # videos: Kyle Samani - $1.65B Solana DAT; Joseph Onorati: Solana DATs; Internet Capital Markets (Akshay BD)
    "What are oracles on Solana, and what does Pyth do?",
    # videos: Pyth Network: Supercharged DeFi Infrastructure; Validated | How Pyth Is Changing the Oracle Game; Walking Through the Pyth Whitepaper

    # — Intermediate: Solana, Pump.fun, trenches, DATs (17–35)
    "How does a Pump.fun launch flow from mint to ‘graduation’ onto a DEX?",
    # videos: How Pumpfun ACTUALLY works | Founder Explains; The OG of Solana DeFi | Orca; Adapting DEX Aggregation to Solana
    "How can I spot red flags and avoid rugs in trench-style launches?",
    # videos: Letterbomb: The Dark Side of Trenching; Critical Security Considerations for Web3 Builders; Safe Solana Stack Smashing by OtterSec
    "How do priority fees work on Solana, and when should I use them?",
    # videos: Solana Changelog Apr 2 - priority fees; Solana Changelog May 1 - priority fees; Stake Weighted QoS
    "What is Firedancer and why is everyone excited about it?",
    # videos: Firedancer w/ Kevin Bowers; Fast Forward From Frankendancer to Firedancer; Spotlight: Firedancer v0 Architecture
    "How does MEV work on Solana at a high level (no math)?",
    # videos: The State of Solana MEV; WTF Is MEV and Why Should We Care?; Solana Validator Education - Jito-Solana Concepts
    "What is Token-2022 and how do transfer hooks help protect users?",
    # videos: Token Extensions on Solana series; Code With the Transfer Hooks Token Extension; Token 2022 in 2023 will define 2024
    "What’s impermanent loss and how does providing LP on Raydium actually work?",
    # videos: The Phoenix Rises: Why Active Liquidity...; Does DEX Liquidity Need a Defense Layer?; What Are You Building? with Orca
    "What are LSTs like JitoSOL or Marinade, and why would I hold them?",
    # videos: Water from a Stone: Liquid Staking on Solana; Jito StakeNet; Marinade (Breakpoint 2024 Product Keynote)
    "How can wallets simulate a trade to warn me about bad outcomes?",
    # videos: What Are You Building? with Dialect; Safe Solana Stack Smashing by OtterSec; Real-Time Security in Solana Ecosystem
    "What’s the difference between AMMs and order books like Phoenix/Ellipsis?",
    # videos: The Phoenix Rises; Atlas: Verifiable Finance At Scale; Adapting DEX Aggregation to Solana
    "What is a DAT vs an RWA, and how are they different from traditional stocks?",
    # videos: Kyle Samani - $1.65B Solana DAT; Tokenization of Capital Markets (Ondo); BP 2024: Société Générale Forge
    "How could creators use Solana Attestation Service (SAS) to build trust?",
    # videos: Solana Attestation Service: Attest to Anything; Ship or Die 2025: SAS talk; What Are You Building? with Dynamic
    "What are on-chain allowlists/KYC gates and do they ruin UX?",
    # videos: Token Extensions on Solana - Regulatory-friendly Finance; Compliant Onchain Products (Exo); Crypto Regulation: Principles-Based Approach
    "How do perps on Drift or Zeta work for someone coming from spot?",
    # videos: DRIFT: Building a Composite CEX-DEX Experience; How Zeta Markets’ L2 Makes a DEX Feel Like a CEX; Scale or Die: The road to Decentralized Nasdaq
    "How can Blinks/Actions make buying a coin or DAT one-tap from social media?",
    # videos: Solana Actions and Blinks; Build Omnichain Programs; In the Blink of an Eye
    "How do oracles get manipulated and what basic defenses exist?",
    # videos: Pyth: Past, Present, and Future; Real-Time Security in Solana Ecosystem; Security and Risk Monitoring for Solana
    "What simple steps should creators take to launch responsibly (vesting, locks, multisig)?",
    # videos: Squads Labs: Accelerating the Onchain Economy; Forgd: Tokenomics, Liquidity, and Beyond; Safe Solana Stack Smashing by OtterSec
    "What telemetry from RPCs/validators helps retail get better fills on Solana?",
    # videos: WTF RPC?; Solana RPC 2.0 Roundtable; High Performance Networking: DoubleZero Enables IBRL
    "What’s the safest way to bridge assets into Solana for new users?",
    # videos: Bridge: Make Money Move; Wormhole Product Keynotes; Debridge: DeFi Doesn't Wait
    "What education should wallets show to explain ‘attention risk’ in trenches?",
    # videos: Letterbomb: The Dark Side of Trenching; Consumer Apps will Eat the World; Resetting Consumer Expectations
]
INPUT_QUERIES_test = [
